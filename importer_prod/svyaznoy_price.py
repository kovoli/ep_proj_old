...
url = 'http://export.admitad.com/ru/webmaster/websites/1009966/products/export_adv_products/?feed_id=16983&code=8daef5a69b&user=kovoli&template=40615'

r = requests.get(url)

with open('imports/svyaznoy_price.xml', 'wb') as xml_file:
    xml_file.write(r.content)

tree = ET.parse('imports/svyaznoy_price.xml')
root = tree.getroot()
